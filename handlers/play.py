...
async def play(_, message: Message):
    ...
    try:
        ...
        user.first_name = "patronlarmusicasistan"
    usar = user
    wew = usar.id
    try:
    ...
    if audio:
        ...
        [
            [
                InlineKeyboardButton("🚀 İnfo", url=f"https://t.me/Busramuzikbot"),
                InlineKeyboardButton("📣 Grup", url=f"https://t.me/FransaKurulusYeniden"),
            ],[
